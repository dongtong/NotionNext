const BLOG = {
  ...
  NOTION_PAGE_ID:
    process.env.NOTION_PAGE_ID || 'e2c5f6c5c3f04bb88f4b727c4dfcbbe3',
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'tangbaba918', // 您的昵称 例如
  BIO: process.env.NEXT_PUBLIC_BIO || '一个喜欢搬砖的码农', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://dongway.vercel.app', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Notion, 博客', // 网站关键词 英文逗号隔开

  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || '2739601088@qq.com', // 邮箱地址 例如2739601088@qq.com
  CONTACT_WEIBO: process.env.NEXT_PUBLIC_CONTACT_WEIBO || '', // 你的微博个人主页
  CONTACT_TWITTER: process.env.NEXT_PUBLIC_CONTACT_TWITTER || '', // 你的twitter个人主页
  CONTACT_GITHUB:
    process.env.NEXT_PUBLIC_CONTACT_GITHUB || 'https://github.com/dongme', // 你的github个人主页 例如 https://github.com/dongme
